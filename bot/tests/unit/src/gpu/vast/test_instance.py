...
# テンプレ実体は bot/src/gpu/vast/onstart.sh.tmpl
# (this file: bot/tests/unit/src/gpu/vast/test_instance.py → parents[5] = bot/)
TEMPLATE_PATH = Path(__file__).resolve().parents[5] / "src/gpu/vast/onstart.sh.tmpl"
