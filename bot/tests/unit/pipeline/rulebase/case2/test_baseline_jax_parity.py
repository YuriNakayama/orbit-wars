"""Numerical-parity tests for the rulebase/case2 JAX core port.
...
from pipeline.rulebase.case2.baseline.core.geometry import (
...
from pipeline.rulebase.case2.baseline.core.physics import (
    estimate_arrival,
    fleet_speed,
    is_static_planet,
...
from pipeline.rulebase.case2.baseline_jax.geometry_jax import (
...
from pipeline.rulebase.case2.baseline_jax.physics_jax import (
    BIG_TURNS,
