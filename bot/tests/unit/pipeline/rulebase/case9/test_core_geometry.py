"""Unit tests for pipeline.rulebase.case9.baseline.core.geometry."""

from __future__ import annotations

import math

from pipeline.rulebase.case9.baseline.core.config import (
    CENTER_X,
    CENTER_Y,
    LAUNCH_CLEARANCE,
    SUN_R,
...
from pipeline.rulebase.case9.baseline.core.geometry import (
