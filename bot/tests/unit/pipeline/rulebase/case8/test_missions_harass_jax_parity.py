"""Parity: case8 HARASS grid vs the Python `build_harass_missions` builder.
...
from pipeline.rulebase.case8.baseline.agent import agent as py_agent
...
from pipeline.rulebase.case8.baseline.core.types import Mission
from pipeline.rulebase.case8.baseline.core.world_model import WorldModel
from pipeline.rulebase.case8.baseline.missions.harass import build_harass_missions
