"""Combat-board target-match: case8 compute_actions vs full Python plan_moves.
...
from pipeline.rulebase.case8.baseline_jax.agent_jax import compute_actions_jit
