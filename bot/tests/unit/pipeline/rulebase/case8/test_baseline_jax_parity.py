"""Numerical-parity tests for the rulebase/case8 JAX core port.
...
from pipeline.rulebase.case8.baseline.core.geometry import (
...
from pipeline.rulebase.case8.baseline_jax.geometry_jax import (
...
from pipeline.rulebase.case8.baseline_jax.physics_jax import (
    BIG_TURNS,
