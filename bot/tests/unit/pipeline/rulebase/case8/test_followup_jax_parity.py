"""Parity: case8 followup pass vs Python `emit_followup_moves`.
...
from pipeline.rulebase.case8.baseline.movements.followup import emit_followup_moves
...
from pipeline.rulebase.case8.baseline_jax.timeline_jax import MAX_PLANETS
