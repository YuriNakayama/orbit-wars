"""Parity: case8 CAPTURE + SNIPE grids vs the Python mission builders.
...
from pipeline.rulebase.case8.baseline.core.types import Mission, ShotOption
from pipeline.rulebase.case8.baseline.core.world_model import WorldModel
from pipeline.rulebase.case8.baseline.missions.capture import (
