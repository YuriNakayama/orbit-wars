"""Case 7 physics mirrors the simulator swept-pair hit test."""

from __future__ import annotations

from pipeline.rulebase.case7.baseline.core import physics
from pipeline.rulebase.case7.baseline.core.types import Planet
