"""Smoke tests for the case12 (baseline_v12) agent."""
...
from pipeline.rulebase.case12.baseline import agent  # noqa: E402


@pytest.mark.integration
@pytest.mark.slow
def test_agent_runs_1v1_to_done() -> None:
    """Full self-play episode — slow because NaïveMCTS rollouts inflate
    per-turn cost under pytest-cov tracing."""
