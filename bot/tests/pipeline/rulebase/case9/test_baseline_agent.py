"""Smoke tests for the case9 (baseline_v9) agent."""
...
from pipeline.rulebase.case9.baseline import agent  # noqa: E402


@pytest.mark.integration
@pytest.mark.slow
def test_agent_runs_1v1_to_done() -> None:
    """Full self-play episode — marked slow because pytest-cov tracing
    overhead inflates per-turn cost. Real rust-backed runs measure
    turn_p95 << 0.7s."""
