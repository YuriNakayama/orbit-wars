"""Unit tests for pipeline.rulebase.case10.baseline.core.physics."""

from __future__ import annotations

import math

from pipeline.rulebase.case10.baseline.core.config import (
    CENTER_X,
    CENTER_Y,
    HORIZON,
    MAX_SPEED,
...
from pipeline.rulebase.case10.baseline.core.physics import (
    aim_with_prediction,
...
# ---------- predict_target_position_fractional (case10-specific) ----------
