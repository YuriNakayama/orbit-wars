"""Bug-reproduction tests for pipeline.imitation.case2.policy.decoder safety.
...
from pipeline.imitation.case2.policy.decoder import decode
from pipeline.imitation.case2.policy.featurizer import MAX_PLANETS
from pipeline.imitation.case2.policy.templates import (
    NUM_TEMPLATES,
    T_NEAREST_ENEMY,
)
from pipeline.imitation.case2.policy.types import PolicyOutput, WorldSnapshot
