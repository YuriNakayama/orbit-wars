"""Bug-reproduction tests for pipeline.imitation.case5.policy.decoder safety.
...
from pipeline.imitation.case5.policy.decoder import decode
from pipeline.imitation.case5.policy.featurizer import MAX_PLANETS
from pipeline.imitation.case5.policy.templates import (
    NUM_TEMPLATES,
    T_NEAREST_ENEMY,
)
from pipeline.imitation.case5.policy.types import PolicyOutput, WorldSnapshot
