"""case8 ship launch event (per-planet enemy targeting + global counts) の動作確認。"""
...
GCOL_ENEMY_LAUNCH_COUNT = 4  # iter4: H1 削除で -2 shift
GCOL_ENEMY_LAUNCH_SHIPS = 5
GCOL_ALLY_LAUNCH_COUNT = 6
GCOL_ALLY_LAUNCH_SHIPS = 7
