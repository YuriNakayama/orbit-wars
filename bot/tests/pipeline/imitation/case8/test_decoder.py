"""Smoke tests for imitation/case8 decoder."""
...
from pipeline.imitation.case8.policy.decoder import decode
...
def test_no_op_when_slot_zero_argmax() -> None:
    ...
    ship_pred = torch.full((1, batch.candidate_mask.shape[1]), 25.0)
    output = PolicyOutput(candidate_logits=logits, ship_pred=ship_pred)
    actions = decode(
        output,
        snap,
        obs,
