...
def test_sun_safe_path_grazes_within_safety_returns_false() -> None:
    ...
    # Source (CENTER_X-30, CENTER_Y - SUN_R - 1.0) heading east => path is
    # 1.0 above sun edge, inside (SUN_R + SUN_SAFETY=11.5) - SUN_R = 1.5 buffer.
    assert not is_trajectory_sun_safe(
...
def test_fleet_crosses_comet_on_collision_path_returns_true() -> None:
    ...
    # Fleet launches at (10, 50) heading east, ships=1 => speed 1.0
    # => at turn 3 fleet is at (13, 50).
    comets = [
        {
            "planet_ids": [99],
...
def test_fleet_crosses_other_comet_excludes_target_planet() -> None:
    # The collision-path comet IS the target planet
    # -> exclude_planet_id silences the check.
    comets = [
        {
            "planet_ids": [99],
            "paths": [[(20.0, 50.0), (17.0, 50.0), (14.0, 50.0), (13.0, 50.0)]],
