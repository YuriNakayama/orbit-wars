"""3-head BC loss for imitation/case7 IL baseline.
...
from pipeline.imitation.case7.policy.featurizer import MAX_PLANETS
from pipeline.imitation.case7.policy.types import PolicyOutput
