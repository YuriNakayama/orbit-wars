"""Evaluate il_v1 (imitation/case7) vs baseline_v1 (rulebase/case1) over N episodes.
...
app = typer.Typer(
    ...
    help="Evaluate imitation/case7 IL vs rulebase/case1 baseline.",
)
...
def _load_params() -> dict[str, Any]:
    # case5 は params.yaml ではなく configs/il_case7.yaml を参照する。
    cfg_path = (
...
def main(
    ...
    out_path = (
        ...
        if out is not None
            ...
            eval_cfg.get("metrics_out", "data/mart/imitation/case7/eval_metrics.json")
        )
    )
