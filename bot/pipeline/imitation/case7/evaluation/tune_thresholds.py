...
Result is saved to data/output/experiment/imitation_case7_threshold_sweep.json.
"""
...
CONFIG_PATH = Path("pipeline/imitation/case7/configs/il_case7.yaml")
WEIGHTS_PATH = Path("pipeline/imitation/case7/policy/weights.pt")
REPORT_PATH = Path("data/output/experiment/imitation_case7_threshold_sweep.json")
