...
Result is saved to data/output/experiment/imitation_case2_threshold_sweep.json.
"""
...
CONFIG_PATH = Path("pipeline/imitation/case2/configs/il_baseline.yaml")
WEIGHTS_PATH = Path("pipeline/imitation/case2/policy/weights.pt")
REPORT_PATH = Path("data/output/experiment/imitation_case2_threshold_sweep.json")
