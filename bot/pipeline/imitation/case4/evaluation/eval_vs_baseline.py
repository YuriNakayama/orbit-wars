"""Evaluate il_v4 (imitation/case4) vs baseline_v1 (rulebase/case1) over N episodes."""
...
app = typer.Typer(
    ...
    help="Evaluate imitation/case4 IL vs rulebase/case1 baseline.",
)
...
def main(
    ...
    out: Path = typer.Option(  # noqa: B008
        Path("pipeline/imitation/case4/evaluation/results.json"), "--out"
    ),
