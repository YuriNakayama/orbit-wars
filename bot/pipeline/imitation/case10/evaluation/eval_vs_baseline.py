"""Evaluate il_v10 (imitation/case10) vs baseline_v1 (rulebase/case1) over N episodes.
...
app = typer.Typer(
    ...
    help="Evaluate imitation/case10 IL vs rulebase/case1 baseline.",
)
...
def _load_params() -> dict[str, Any]:
    # case10 は params.yaml ではなく configs/il_case10.yaml を参照する。
    cfg_path = (
        find_repo_root(Path(__file__))
        / "bot/pipeline/imitation/case10/configs/il_case10.yaml"
    )
...
def main(
    ...
    out_path = (
        ...
        if out is not None
            ...
            eval_cfg.get("metrics_out", "data/mart/imitation/case10/eval_metrics.json")
        )
    )
