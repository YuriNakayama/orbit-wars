...
Result is saved to data/output/experiment/imitation_case5_threshold_sweep.json.
"""
...
CONFIG_PATH = Path("pipeline/imitation/case5/configs/il_case5.yaml")
WEIGHTS_PATH = Path("pipeline/imitation/case5/policy/weights.pt")
REPORT_PATH = Path("data/output/experiment/imitation_case5_threshold_sweep.json")
