"""Evaluate il_v1 (imitation/case5) vs baseline_v1 (rulebase/case1) over N episodes.
...
app = typer.Typer(
    ...
    help="Evaluate imitation/case5 IL vs rulebase/case1 baseline.",
)
...
def main(
    ...
    out_path = (
        ...
        if out is not None
            ...
            eval_cfg.get("metrics_out", "data/mart/imitation/case5/eval_metrics.json")
        )
    )
