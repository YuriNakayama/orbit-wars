...
```bash
uv run pytest tests/pipeline/imitation/case5 -v -m "not slow"
uv run pytest tests/pipeline/imitation/case5 -v   # determinism 含む
```

## 設計原則

- **case 間独立**: `pipeline/imitation/case5/` は `pipeline/rulebase/case[012]/` に依存しない / されない。
