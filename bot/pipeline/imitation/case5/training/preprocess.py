"""Replay → parquet preprocess for imitation/case5 IL baseline.
...
from pipeline.imitation.case5.policy.featurizer import (
    GLOBAL_FEAT_DIM,
    MAX_PLANETS,
    PLANET_FEAT_DIM,
    featurize,
)
from pipeline.imitation.case5.policy.geometry import Planet, aim_with_prediction
