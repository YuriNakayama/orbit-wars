"""obs (dict) → BatchFeatures (torch.Tensor) for imitation/case5 IL baseline.
...
PLANET_FEAT_DIM = 17  # case1 base 11 + ship-prediction timeline 6
GLOBAL_FEAT_DIM = 6
MAX_PLANETS = 36
BOARD_SIZE = 100.0
...
def featurize(obs: Any) -> tuple[BatchFeatures, WorldSnapshot]:
    ...
    # ship-prediction 用 arrivals: slot ごとに (eta, owner, ships) を蓄積
