"""Evaluate il_v11 (imitation/case11) vs baseline_v1 (rulebase/case1) over N episodes.
...
app = typer.Typer(
    ...
    help="Evaluate imitation/case11 IL vs rulebase/case1 baseline.",
)
...
def _load_params() -> dict[str, Any]:
    # case11 は params.yaml ではなく configs/il_case11.yaml を参照する。
    cfg_path = (
        find_repo_root(Path(__file__))
        / "bot/pipeline/imitation/case11/configs/il_case11.yaml"
    )
...
def main(
    ...
    out_path = (
        ...
        if out is not None
            ...
            eval_cfg.get("metrics_out", "data/mart/imitation/case11/eval_metrics.json")
        )
    )
