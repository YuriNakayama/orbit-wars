"""Replay a single il_v6 vs baseline_v1 match for a given seed with save_replay=True.
...
Usage:
    uv run python -m pipeline.imitation.case6.evaluation.replay_match \\
        --seed 19 --label win
"""
...
DEFAULT_OUT_DIR = Path("data/output/experiment/imitation_case6_replays")
