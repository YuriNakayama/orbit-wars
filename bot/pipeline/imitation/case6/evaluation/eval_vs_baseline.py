"""Evaluate il_v6 (imitation/case6) vs baseline_v1 (rulebase/case1) over N episodes.
...
app = typer.Typer(
    ...
    help="Evaluate imitation/case6 IL vs rulebase/case1 baseline.",
)
...
def _load_params() -> dict[str, Any]:
    # case6 は params.yaml ではなく configs/il_case6.yaml を参照する。
    cfg_path = (
...
def main(
    ...
    out_path = (
        ...
        if out is not None
            ...
            eval_cfg.get("metrics_out", "data/mart/imitation/case6/eval_metrics.json")
        )
    )
