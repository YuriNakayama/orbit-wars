...
Result is saved to data/output/experiment/imitation_case6_threshold_sweep.json.
"""
...
CONFIG_PATH = Path("pipeline/imitation/case6/configs/il_case6.yaml")
WEIGHTS_PATH = Path("pipeline/imitation/case6/policy/weights.pt")
REPORT_PATH = Path("data/output/experiment/imitation_case6_threshold_sweep.json")
