"""PPO + BC warm-start training loop for reinforce/case4.
...
from pipeline.reinforce.case4.policy.model import (
    ActorCritic,
    ModelConfig,
    count_parameters,
    load_bc_weights,
)
from pipeline.reinforce.case4.training.env import OpponentAgent, random_noop_agent
from pipeline.reinforce.case4.training.ppo import PPOConfig, ppo_update
from pipeline.reinforce.case4.training.rollout import (
    RolloutWorkerPool,
    collect_rollout,
    resolve_num_workers,
)
...
_CONFIG_OPTION = typer.Option(
    Path("pipeline/reinforce/case4/configs/smoke.yaml"),
    "--config",
