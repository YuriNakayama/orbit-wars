"""PPO + BC warm-start training loop for reinforce/case6.
...
from pipeline.reinforce.case6.policy.model import (
    ActorCritic,
    ModelConfig,
    count_parameters,
    load_bc_weights,
)
from pipeline.reinforce.case6.training.env import OpponentAgent, random_noop_agent
from pipeline.reinforce.case6.training.ppo import PPOConfig, ppo_update
from pipeline.reinforce.case6.training.rollout import (
    RolloutWorkerPool,
    collect_rollout,
    resolve_num_workers,
)
...
_CONFIG_OPTION = typer.Option(
    Path("pipeline/reinforce/case6/configs/smoke.yaml"),
    "--config",
