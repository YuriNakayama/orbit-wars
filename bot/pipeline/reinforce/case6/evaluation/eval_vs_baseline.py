"""Evaluate rl_v3 (reinforce/case6) vs a chosen baseline over N episodes."""
...
app = typer.Typer(
    ...
    help="Evaluate reinforce/case6 (PPO + BC warm-start) vs a chosen baseline.",
)
...
def main(
    ...
    out_path = (
        _abspath(out)
        if out is not None
        else _abspath("data/mart/reinforce/case6/eval_metrics.json")
    )
    spec = RunSpec(
