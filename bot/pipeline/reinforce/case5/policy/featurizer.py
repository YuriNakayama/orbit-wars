"""Featurizer for imitation/case9.
...
Independent copy: case9 does not import from case5/case8 (case-independence rule).
"""
...
class HistoryState:
    ...
    Identical contract to case5 (avoid label leak: read [-2] / [-3] not [-1]).
    """
