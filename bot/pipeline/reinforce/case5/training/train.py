"""PPO + BC warm-start training loop for reinforce/case5.
...
from pipeline.reinforce.case5.policy.model import (
    ActorCritic,
    ModelConfig,
    count_parameters,
    load_bc_weights,
)
from pipeline.reinforce.case5.training.env import OpponentAgent, random_noop_agent
from pipeline.reinforce.case5.training.ppo import PPOConfig, ppo_update
from pipeline.reinforce.case5.training.rollout import (
    RolloutWorkerPool,
    collect_rollout,
    resolve_num_workers,
)
...
_CONFIG_OPTION = typer.Option(
    Path("pipeline/reinforce/case5/configs/smoke.yaml"),
    "--config",
