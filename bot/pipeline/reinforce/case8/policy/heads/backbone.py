"""Set Transformer backbone shared by all 3 head variants of case9.

Encoder = ISAB×3 (m=16) + PMA bottleneck + global concat (case8 と同等)。
Output:
...
case8 model.py からのコピー (cross-case import 禁止のため)。
"""
...
class SetTransformerBackbone(nn.Module):
    """Encoder + Bottleneck shared by every head variant in case9."""
