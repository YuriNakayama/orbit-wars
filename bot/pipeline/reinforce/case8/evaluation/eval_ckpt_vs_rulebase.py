...
train_jax) or a `best.pt`, converts it to a PyTorch state_dict, points the case8
...
Usage (from bot/):
    uv run python -m pipeline.reinforce.case8.evaluation.eval_ckpt_vs_rulebase \
        --ckpt data/output/models/reinforce/case8_train_jax/runs/<run>/ckpt_i010.pt \
...
app = typer.Typer(add_completion=False, help="Evaluate a case8 JAX ckpt vs a rulebase.")
