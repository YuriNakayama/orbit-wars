"""Evaluate rl_v3 (reinforce/case8) vs a chosen baseline over N episodes."""
...
app = typer.Typer(
    ...
    help="Evaluate reinforce/case8 (PPO + BC warm-start) vs a chosen baseline.",
)
...
def main(
    ...
    out_path = (
        _abspath(out)
        if out is not None
        else _abspath("data/mart/reinforce/case8/eval_metrics.json")
    )
    spec = RunSpec(
