...
# Usage:
#   cd bot
#   bash pipeline/reinforce/case8/training/watch_and_eval.sh <run_id> <case>
#
# Args:
#   $1 run_id (e.g. 20260601-191229__feature-agent-pool-learning__06b6faf__seed0)
#   $2 case (e.g. reinforce_case8_kaggle_jax_train_pool_v1)
# Env:
...
# Derive case_subdir for post_train_eval (e.g. reinforce_case8_kaggle_jax_train_pool_v1
# -> case8_kaggle_jax_train_pool_v1). The run dir mirrors the case suffix.
...
echo "==> done. result: data/mart/reinforce/case8/eval_metrics.json"
