"""Evaluate rl_v3 (reinforce/case7) vs a chosen baseline over N episodes."""
...
app = typer.Typer(
    ...
    help="Evaluate reinforce/case7 (PPO + BC warm-start) vs a chosen baseline.",
)
...
def main(
    ...
    out_path = (
        _abspath(out)
        if out is not None
        else _abspath("data/mart/reinforce/case7/eval_metrics.json")
    )
    spec = RunSpec(
