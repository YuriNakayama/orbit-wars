...
`pipeline/reinforce/case7/` は **case6 の PFSP (Prioritized Fictitious
...
```bash
cd bot
uv run python -m pipeline.reinforce.case7.training.train_jax \
  --config pipeline/reinforce/case7/configs/local_combo_20min.yaml
```
...
(case7 は opponent 基盤を case6 から、shaping を case5 から継承)。
...
- case6 PFSP は JAX 自己対戦で伸びても **本物 baseline_v1 戦で 0/10** だった
  ...
  case7 も live 300戦 + featurizer parity での検証が採否の前提。
