...
# Usage:
#   cd bot
#   bash pipeline/reinforce/case7/training/post_train_eval.sh <run_id>
#
# Inputs:
...
#     default: case7_kaggle_jax_train_pool_v1 (matches case_arg in cases.py)
#   $EPISODES (env, optional, default 30): number of eval episodes (local constraint)
#   $BASELINE (env, optional, default baseline_v1)
#
# Outputs:
#   pipeline/reinforce/case7/policy/weights.pt (updated)
#   data/mart/reinforce/case7/eval_metrics.json (eval result + Wilson CI)
#
...
RUN_ID="$1"
CASE_SUBDIR="${POST_TRAIN_CASE_SUBDIR:-case7_kaggle_jax_train_pool_v1}"
EPISODES="${EPISODES:-30}"
BASELINE="${BASELINE:-baseline_v1}"

RUN_DIR="data/output/models/reinforce/${CASE_SUBDIR}/runs/${RUN_ID}"
BEST_PT="${RUN_DIR}/best.pt"
WEIGHTS_OUT="pipeline/reinforce/case7/policy/weights.pt"
...
uv run python -m pipeline.reinforce.case7.training.jax_to_torch \
...
echo "==> done. metrics: data/mart/reinforce/case7/eval_metrics.json"
