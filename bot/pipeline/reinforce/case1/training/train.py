"""PPO + BC warm-start training loop for reinforce/case1.
...
from pipeline.reinforce.case1.policy.model import (
    ActorCritic,
    ModelConfig,
    count_parameters,
    load_bc_weights,
...
_CONFIG_OPTION = typer.Option(
    Path("pipeline/reinforce/case1/configs/smoke.yaml"),
    "--config",
