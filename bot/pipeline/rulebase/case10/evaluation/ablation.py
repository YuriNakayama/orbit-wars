"""Ablation helper: toggle a case10 config flag, run N games vs case2, report v4 win rate."""
...
CONFIG_PATH = Path("pipeline/rulebase/case10/baseline/core/config.py")
...
def ablate(
    ...
    try:
        ...
        run_a = _run(["baseline_v4", "baseline_v2"], episodes_per_side, seed, parallel)
        run_b = _run(
            ["baseline_v2", "baseline_v4"], episodes_per_side, seed + 500, parallel
        )
