...
"""Kaggle submission entry point for case10.

Kaggle executes this file directly; the `pipeline.rulebase.case10` parent
...
`pipeline.rulebase.case10.baseline` (local) and `baseline` (Kaggle).
"""
