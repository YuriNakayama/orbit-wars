...
"""Kaggle submission entry point for case8.

Kaggle executes this file directly; the `pipeline.rulebase.case8` parent
...
`pipeline.rulebase.case8.baseline` (local) and `baseline` (Kaggle).
"""
