...
"""Kaggle submission entry point for case7.

Kaggle executes this file directly; the `pipeline.rulebase.case7` parent
...
`pipeline.rulebase.case7.baseline` (local) and `baseline` (Kaggle).
"""
