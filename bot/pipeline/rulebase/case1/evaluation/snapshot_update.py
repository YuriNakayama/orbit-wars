"""Regenerate the action snapshot used by tests/pipeline/rulebase/case1/.

Capture/write helpers live in `src/evaluation/snapshot_update.py`; this wrapper
binds them to the case1 baseline agent and the case1 snapshot paths.
"""
...
from pipeline.rulebase.case1.baseline import agent as baseline_agent
from utils.repo_root import find_repo_root

app = typer.Typer(add_completion=False, help="Snapshot updater for case1 baseline.")

REPO_ROOT = find_repo_root(Path(__file__))
DEFAULT_SNAPSHOT_DIR = (
    REPO_ROOT / "tests" / "pipeline" / "rulebase" / "case1" / "snapshots"
)
