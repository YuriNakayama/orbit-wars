"""Regenerate the action snapshot used by tests/pipeline/rulebase/case13/.

Capture/write helpers live in `src/evaluation/snapshot_update.py`; this wrapper
binds them to the case13 baseline agent and the case13 snapshot paths.
"""
...
from pipeline.rulebase.case13.baseline import agent as baseline_agent
from utils.repo_root import find_repo_root

app = typer.Typer(add_completion=False, help="Snapshot updater for case13 baseline.")

REPO_ROOT = find_repo_root(Path(__file__))
DEFAULT_SNAPSHOT_DIR = (
    REPO_ROOT / "tests" / "pipeline" / "rulebase" / "case13" / "snapshots"
)
