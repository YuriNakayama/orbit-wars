...
"""Kaggle submission entry point for case13.

Kaggle executes this file directly; the `pipeline.rulebase.case13` parent
...
`pipeline.rulebase.case13.baseline` (local) and `baseline` (Kaggle).
"""
