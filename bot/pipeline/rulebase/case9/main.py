...
"""Kaggle submission entry point for case9.

Kaggle executes this file directly; the `pipeline.rulebase.case9` parent
...
`pipeline.rulebase.case9.baseline` (local) and `baseline` (Kaggle).
"""
