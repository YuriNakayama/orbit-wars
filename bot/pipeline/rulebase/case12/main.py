...
"""Kaggle submission entry point for case12.

Kaggle executes this file directly; the `pipeline.rulebase.case12` parent
...
`pipeline.rulebase.case12.baseline` (local) and `baseline` (Kaggle).
"""
