...
"""Kaggle submission entry point for case6.

Kaggle executes this file directly; the `pipeline.rulebase.case6` parent
...
`pipeline.rulebase.case6.baseline` (local) and `baseline` (Kaggle).
"""
