...
MULTI_SOURCE_PLAN_PENALTY: float = 0.97
...
THREE_SOURCE_PLAN_PENALTY: float = 0.93
...
REINFORCE_FRESH_CAPTURE_ENABLED: bool = True
REINFORCE_FRESH_CAPTURE_WINDOW: int = 10
...
ROLLOUT_TOP_K: int = 3
ROLLOUT_DEPTH: int = 3
ROLLOUT_SCORE_BONUS: float = 0.08
ROLLOUT_MODE: str = "true2p"

ROLLOUT_FILTER_ENABLED: bool = False
ROLLOUT_FILTER_TOP_K: int = 5
ROLLOUT_FILTER_DEPTH: int = 3
ROLLOUT_FILTER_MIN_MARGIN: float = 0.0
