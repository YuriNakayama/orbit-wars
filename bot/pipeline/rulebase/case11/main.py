...
"""Kaggle submission entry point for case11.

Kaggle executes this file directly; the `pipeline.rulebase.case11` parent
...
`pipeline.rulebase.case11.baseline` (local) and `baseline` (Kaggle).
"""
