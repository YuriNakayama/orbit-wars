...
CASE_DEFAULTS: dict[str, dict[str, str]] = {
    ...
    # scripts/gpu_smoke.py which prints CUDA availability / GPU name / VRAM,
    # does one tiny CUDA tensor op, and exits 0. Designed to validate the
    # RunPod basis end-to-end in seconds (no DVC pull / preprocess / mart).
    "smoke_gpu": {
        "stage": "smoke_gpu",
        "train_module": "scripts.gpu_smoke",
        "config_arg": "",
        "preprocess_cmd": "",
        "canonical_weights": "",
    },
