...
def _cell_install_bot(dataset_mount: str) -> str:
    ...
    return (
        ...
        "    REPO_ROOT + '/bot',\n"
        "    REPO_ROOT,\n"
        "    REPO_ROOT + '/simulator/jax',\n"
        "    REPO_ROOT + '/simulator/adapter',\n"
...
def _cell_parquet_to_npy(ctx: RenderContext) -> str:
    ...
    return (
        ...
        "    '/tmp/orbit-wars-repo:'\n"
        "    '/tmp/orbit-wars-repo/simulator/jax:'\n"
        "    '/tmp/orbit-wars-repo/simulator/adapter:'\n"
        "    '/tmp/orbit-wars-repo/simulator/python'\n"
        ")\n"
