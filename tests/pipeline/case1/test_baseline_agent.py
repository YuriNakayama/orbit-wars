"""Integration + snapshot tests for the baseline agent."""
...
from pipeline.case1.baseline import agent  # noqa: E402
...
def test_agent_snapshot_first_turn_action() -> None:
    ...
    if not SNAPSHOT_OBS.exists() or not SNAPSHOT_ACTION.exists():
        pytest.skip(
            ...
            "`uv run python -m pipeline.case1.evaluation.snapshot_update` first"
        )
