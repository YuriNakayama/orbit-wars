"""Unit tests for case2 opponent_model pure-function library."""

from __future__ import annotations

from pipeline.rulebase.case2.baseline import opponent_model as om
from pipeline.rulebase.case2.baseline.core.types import Fleet, Planet
