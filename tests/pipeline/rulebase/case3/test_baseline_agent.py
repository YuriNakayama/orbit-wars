"""Integration + snapshot tests for the case3 agent."""
...
from pipeline.rulebase.case3.baseline import agent  # noqa: E402
...
def test_agent_snapshot_first_turn_action() -> None:
    ...
    if not SNAPSHOT_OBS.exists() or not SNAPSHOT_ACTION.exists():
        pytest.skip(
            ...
            "`uv run python -m pipeline.rulebase.case3.evaluation"
