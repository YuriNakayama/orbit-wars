"""Unit tests for case3 `WorldModel` construction from a synthetic observation."""

from __future__ import annotations

from pipeline.rulebase.case3.baseline.agent import build_world
from pipeline.rulebase.case3.baseline.core.types import Planet
