"""Unit tests for case2 `WorldModel` construction from a synthetic observation."""

from __future__ import annotations

from pipeline.case2.baseline.agent import build_world
from pipeline.case2.baseline.core.types import Planet
