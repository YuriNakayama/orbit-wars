...
Run **one round** of `a concise user question` (3 questions). Selection + Other format. The first question's description: `各質問で「Other」を選ぶと自由記述も可能です。`
...
- **All user-facing output, a concise user question labels/descriptions, and tick reports must be in Japanese** (per `.codex/AGENTS.md`)
