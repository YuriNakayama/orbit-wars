...
```bash
python3 .agents/skills/learn/scripts/instinct-cli.py evolve [--generate]
```
...
```
/instinct-evolve                    # Analyze all instincts and suggest evolutions
/instinct-evolve --domain testing   # Only evolve instincts in testing domain
/instinct-evolve --dry-run          # Show what would be created without creating
/instinct-evolve --threshold 5      # Require 5+ related instincts to cluster
```
...
---
Run `/instinct-evolve --execute` to create these files.
```
