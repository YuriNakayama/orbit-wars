...
```bash
python3 .agents/skills/learn/scripts/instinct-cli.py status
```
...
1. Read all instinct files from `~/.codex/homunculus/instincts/personal/`
2. Read inherited instincts from `~/.codex/homunculus/instincts/inherited/`
