...
**General Python rules** for editing `.py` / `.ipynb` files in this repository. Read this before touching Python code in `bot/`, `pipeline/`, tests, notebooks, etc.

For case-directory submit structure see `.agents/rules/bot/pipeline.md`. For pytest conventions see `.agents/rules/bot/tests.md`.
