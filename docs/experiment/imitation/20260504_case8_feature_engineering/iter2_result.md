# imitation/case8 iter2 — Result (parity、Stage 1 ゲート未達 → iter3 へ)
...
> weights: `data/output/models/imitation/case8/runs/20260505-062823__.../best.pt` (epoch 9, val_loss=3.5142、canonical には昇格しない)
...
- canonical weights `bot/pipeline/imitation/case8/policy/weights.pt` は **iter2 best.pt のまま保持**
...
- run artifacts は `data/output/models/imitation/case8/runs/20260505-062823__.../` に保存
...
- featurizer (iter2): `bot/pipeline/imitation/case8/policy/featurizer.py` (34/14 schema)
- weights (iter2): `data/output/models/imitation/case8/runs/20260505-062823__feature-feature-engineering__850c34e__seed0/best.pt`
- val metrics: `/tmp/case8_iter2_val_metrics.json` (もし保持するなら `data/output/experiment/imitation_case8_iter2_val_metrics.json` に移動)
- 訓練 metrics: `data/output/models/imitation/case8/runs/20260505-062823__.../metrics.json`
