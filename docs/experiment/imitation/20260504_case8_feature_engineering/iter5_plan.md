# imitation/case8 iter5 — ships F1 0.93 の適宜性診断
...
> - `bot/pipeline/imitation/case8/policy/featurizer.py` — iter4 で 61/12 schema
>
...
- iter4 weights は `bot/pipeline/imitation/case8/policy/weights.pt` で canonical
- val parquet: `data/mart/imitation/case8/val.parquet` (38,278 frames、iter4 schema)
...
| Path | 内容 |
|------|------|
| `data/output/experiment/imitation_case8_iter4_grouped_importance.json` | iter3 と同じ機能別 group permutation importance を iter4 weights で実行 |
| `data/output/experiment/imitation_case8_iter4_k4_ablation.json` | K4 列だけを zero-out して val metrics を測る |
| `data/output/experiment/imitation_case8_iter4_ships_class_distribution.json` | val_ds で ships_per_src の class distribution + confusion matrix |
| `docs/experiment/imitation/20260504_case8_feature_engineering/iter5_result.md` | 3 診断の結論 + iter4 採用判定の最終確認 |
