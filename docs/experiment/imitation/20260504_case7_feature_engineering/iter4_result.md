# imitation/case7 iter4 — Result (大幅採用、ships head 劇的改善)
...
> weights: `bot/pipeline/imitation/case7/policy/weights.pt` (iter4 best.pt epoch 13, val_loss=3.3576)
...
**全面採用**。canonical weights `bot/pipeline/imitation/case7/policy/weights.pt` は **iter4 best.pt (val_loss 3.3576)** にすでに昇格済 (本サイクル内で)。
...
- featurizer (iter4): `bot/pipeline/imitation/case7/policy/featurizer.py` (61/12 schema)
- weights (iter4): `bot/pipeline/imitation/case7/policy/weights.pt` (iter4 best.pt copy)
- run dir: `data/output/models/imitation/case7/runs/20260505-102543__feature-feature-engineering__8fe82ae__seed0/`
- val metrics: `/tmp/case7_iter4_val_metrics.json`
