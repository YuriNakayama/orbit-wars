# imitation/case7 iter6 — Result (K2 leak 除去確認、ships F1 0.93 → 0.63 で iter1 parity)
...
> weights: `bot/pipeline/imitation/case7/policy/weights.pt` (iter6 best.pt epoch 12, val_loss=3.5060)
...
- **iter6 を新 baseline として採用** (`bot/pipeline/imitation/case7/policy/weights.pt` に promote 済み)
...
- [x] case7 featurizer/configs/tests が iter6 仕様 (PLANET=57, GLOBAL=8) に整理、unit test pass
...
- `data/output/models/imitation/case7/runs/20260506-010029__feature-feature-engineering__0895b65__seed0/metrics.json`
