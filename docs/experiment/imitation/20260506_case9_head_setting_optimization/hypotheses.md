...
2. **candidate head 単独** (per-source × CAND_K=8 × 14, case4/case8 由来)
3. **candidate head + ships head** (candidate で source/slot 選択 + ships で発射数 4-bucket categorical)
...
| 2 | 2026-05-07 | H4 dual_head_blend_alpha_0_5 | iter2_plan.md | 未起動 | targeted=pass / smoke=pass / runpod_case=registered | 実行待ち | iter2_result.md |
