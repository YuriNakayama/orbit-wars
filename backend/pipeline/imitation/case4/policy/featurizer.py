"""Featurizer for imitation/case4.

Identical planet (35) + global (20) feature blocks as case3 phase2 (history
features included), but the per-source `template_ctx` block is replaced with a
**per-source candidate block** (CAND_K=8, CAND_FEAT_DIM=14) à la the Kaggle
tutorial.

Independent copy: case4 does not import from case3 (case-independence rule).
"""
