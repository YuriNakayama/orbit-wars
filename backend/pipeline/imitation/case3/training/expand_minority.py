"""Polars-based minority row duplication for imitation/case3.
...
Usage:
  uv run python -m pipeline.imitation.case3.training.expand_minority \\
      --in-parquet data/mart/imitation/case3/train_q30.parquet \\
      --out-parquet data/mart/imitation/case3/train_q30_dup.parquet \\
      --minority 0,2,5,6,7 \\
      --multiplier 2
"""
