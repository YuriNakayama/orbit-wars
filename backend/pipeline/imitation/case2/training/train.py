"""BC training loop for imitation/case2 IL baseline.
...
from pipeline.imitation.case2.policy.featurizer import GLOBAL_FEAT_DIM, PLANET_FEAT_DIM
...
from pipeline.imitation.case2.training.losses import (
    LossWeights,
