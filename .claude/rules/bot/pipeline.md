...
General Python rules (type hints, logging, naming, etc.) and bot library Module Architecture live in `.claude/rules/python.md`. This file focuses on **case-directory-specific submit structure conventions**.
