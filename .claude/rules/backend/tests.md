...
Pytest conventions for the backend test suite. General Python rules (type hints, logging, naming) live in `.claude/rules/python.md`.
...
# Specific module
uv run --directory backend pytest tests/<path> -x --no-header -q
```
