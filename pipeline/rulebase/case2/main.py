...
"""Kaggle submission entry point for case2.

Kaggle executes this file directly; the `pipeline.rulebase.case2` parent
...
`pipeline.rulebase.case2.baseline` (local) and `baseline` (Kaggle).
"""
