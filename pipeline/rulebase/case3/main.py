...
"""Kaggle submission entry point for case3.

Kaggle executes this file directly; the `pipeline.rulebase.case3` parent
...
`pipeline.rulebase.case3.baseline` (local) and `baseline` (Kaggle).
"""
