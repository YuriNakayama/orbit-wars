"""Ablation helper: toggle a case2 config flag, run N games vs case1, report v2 win rate."""
...
CONFIG_PATH = Path("pipeline/case2/baseline/core/config.py")
DATA_ROOT = Path("data")
...
def ablate(
    ...
    try:
        ...
        run_a = _run(["baseline_v2", "baseline_v1"], episodes_per_side, seed, parallel)
        run_b = _run(
            ["baseline_v1", "baseline_v2"], episodes_per_side, seed + 500, parallel
        )
