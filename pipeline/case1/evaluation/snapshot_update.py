"""Regenerate the action snapshot used by tests/pipeline/case1/.
...
from pipeline.case1.baseline import agent as baseline_agent

app = typer.Typer(add_completion=False, help="Snapshot updater for baseline agent.")

REPO_ROOT = Path(__file__).resolve().parents[3]
DEFAULT_SNAPSHOT_DIR = REPO_ROOT / "tests" / "pipeline" / "case1" / "snapshots"
